...
for a users bet. I tested the formula used here by generating 100,000 points in python to verify a high degree of accuracy relative to the industry
(as I'm using a non standard method of calculation) and it was, as shown by this histogram (source code provided here too) of those 1e5 points:
** Get updated test proof link **
...
        play
    }
    $userMultiplier = Read-Host "When do you want to cash out"
    if ($userMultiplier -le 1) {
        Write-Host "Cannot set multiplier to 1 or lower, try again"
        play
    }
